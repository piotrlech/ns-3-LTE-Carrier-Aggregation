...
class LteEnbMac :   public Object
{
  ...
  friend class MemberLteUlCcmMacSapProvider<LteEnbMac>;
...
public:
  ...
  */
  LteUlCcmMacSapProvider* GetLteUlCcmMacSapProvider ();

  /**
  * \brief Set the ComponentCarrierManager for the Uplink SAP Provider
  * \param s a pointer to the ComponentCarrierManager provider
  */
  void SetLteUlCcmMacSapUser (LteUlCcmMacSapUser* s);
...
private:
  ...
  */
  ...
  // forwarded by LteUlCcmMacSapProvider
