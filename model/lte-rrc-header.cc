 ...
 *         Danilo Abrignani <danilo.abrignani@unibo.it> (Update to R10 - Carrier Aggregation - GSoC 2015)
 */
...
namespace ns3 {
        ...
        for (std::list<LteRrcSap::SCellToAddMod>::iterator it = nonCriticalExtension.sCellsToAddModList.begin (); it != nonCriticalExtension.sCellsToAddModList.end (); it++)
          {
            ...
            SerializeInteger (it->sCellIndex,1,65536); //sCellIndex         
            ...
            SerializeInteger (it->cellIdentification.dlCarrierFreq,1,65536);
    ...
    if (radioResourceConfigCommonSCell_r10[0])
      {
        ...
        //Serialize ulFreqInfo
         ...
         SerializeInteger (rrccsc.ulConfiguration.ulFreqInfo.ulCarrierFreq,0,65536);
        ...
        if (nonCriticalExtension_v920[0])
          {
            ...
            int numElems;
            bIterator = DeserializeSequenceOf (&numElems,MAX_SCELL_CONF,1,bIterator);
  ...
  RrcAsn1Header::DeserializeCellIdentification (LteRrcSap::CellIdentification *ci, Buffer::Iterator bIterator)
  {
    ...
    int n1;
    bIterator = DeserializeInteger (&n1,1,2,bIterator);
    ci->physCellId = n1;
    int n2;
    bIterator = DeserializeInteger (&n2,1,2,bIterator);
    ci->dlCarrierFreq = n2;
