...
public:
  ...
  LteEnbCmacSapUser* GetLteEnbCmacSapUser (uint16_t pos);
  ...
  void SetLteFfrRrcSapProvider (LteFfrRrcSapProvider * s, uint16_t index);
  ...
  LteFfrRrcSapUser* GetLteFfrRrcSapUser (uint16_t index);
   ...
   */
  void ConfigureCell (std::map<uint8_t, Ptr<ComponentCarrierEnb> > ccm,
                      uint16_t cellId);
