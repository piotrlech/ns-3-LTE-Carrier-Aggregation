...
void
LteUeRrc::SetLteUeCphySapProvider (LteUeCphySapProvider * s, uint16_t index)
{
  NS_LOG_FUNCTION (this << s);
  m_cphySapProvider[index] = s;
}
...
LteUeCphySapUser*
LteUeRrc::GetLteUeCphySapUser (uint16_t index)
{
  NS_LOG_FUNCTION (this);
  return m_cphySapUser[index];
}
...
LteUeRrc::GetLteCcmRrcSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
LteUeRrc::DoInitialize (void)
{
  ...
  // DANILO
  NS_LOG_LOGIC("LteUeRrc::DoInitialize::m_ccmRrcSapProvider=" << m_ccmRrcSapProvider << ", rlc->GetLteMacSapUser()=" << rlc->GetLteMacSapUser ());
  LteMacSapUser* MacSapUserForRlc = m_ccmRrcSapProvider->ConfigureSignalBearer (0, lcConfig, rlc->GetLteMacSapUser ()); 
  m_cmacSapProvider.at(0)->AddLc (lcid, lcConfig, MacSapUserForRlc);
  test();
}
...
LteUeRrc::test()
{
  LteUeCcmRrcSapProvider* tm_ccmRrcSapProvider = GetLteCcmRrcSapProvider ();

  NS_LOG_LOGIC ("LteUeRrc::test=" << this << ", " << GetLteCcmRrcSapProvider () << ", " << m_ccmRrcSapProvider<< ", " << tm_ccmRrcSapProvider);
  m_ccmRrcSapProvider->AmIalive ();
}
  ...
  if (stamIt != rrcd.srbToAddModList.end ())
    {
      if (m_srb1 == 0)
        {
          // SRB1 not setup yet
          NS_LOG_DEBUG (this << " SRB1 not configured");
           ...
           * \return the LteMacSapUser of the ComponentCarrierManager
              ...
              lcConfig.logicalChannelGroup = 0;   // all SRBs mapped to LCG 0
              // DANILO
              //NS_LOG_UNCOND("LteUeRrc::DoInitialize::m_ccmRrcSapProvider=" << m_ccmRrcSapProvider << ", rlc->GetLteMacSapUser()=" << rlc->GetLteMacSapUser ());
              LteMacSapUser* MacSapUserForRlc = m_ccmRrcSapProvider->ConfigureSignalBearer (0, lcConfig, rlc->GetLteMacSapUser ()); 
              LteMacSapUser*
              LteRlc::GetLteMacSapUser ()
           */
          NS_LOG_LOGIC("LteUeRrc::ApplyRadioResourceConfigDedicated::m_ccmRrcSapProvider=" << m_ccmRrcSapProvider <<
                        ", rlc->GetLteMacSapUser()=" << rlc->GetLteMacSapUser ());
          LteMacSapUser* MacSapUserForRlc;
          MacSapUserForRlc = rlc->GetLteMacSapUser ();
          //m_ccmRrcSapProvider->NotifyConnectionReconfigurationMsg ();
          //m_ccmRrcSapProvider->ConfigureSignalBearer (1, lcConfig, rlc->GetLteMacSapUser ());
          // KWAS - poprzednio było:
          //MacSapUserForRlc = m_ccmRrcSapProvider->ConfigureSignalBearer (1, lcConfig, rlc->GetLteMacSapUser ());
...
void
LteUeRrc::DoComponentCarrierEnabling (std::vector<uint16_t> res)
  {
    NS_LOG_INFO (this);
  }
