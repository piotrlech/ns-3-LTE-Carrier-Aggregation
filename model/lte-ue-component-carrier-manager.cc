...
bool 
LteUeComponentCarrierManager::SetComponentCarrierMacSapProviders (uint16_t componentCarrierId, LteMacSapProvider* sap)
{
...
void
LteUeComponentCarrierManager::SetComponentCarrierNumber (uint16_t no)
{
  NS_LOG_FUNCTION (this);
