...
public:
  ...
  /**
   * \return a pointer to the MAC of the SCC addressed by index.
   */
  ...
  /**
   * \brief Set the ComponentCarrier Map for the Enb
...
private:
  ...
  Ptr<LteEnbMac> m_mac; /**< DEPRECATE - It is maintained for backward compatibility */

  Ptr<LteEnbPhy> m_phy; /**< DEPRECATE - It is maintained for backward compatibility */

  Ptr<LteEnbRrc> m_rrc;

  Ptr<FfMacScheduler> m_scheduler; /**< DEPRECATE - It is maintained for backward compatibility */

  Ptr<LteHandoverAlgorithm> m_handoverAlgorithm;

  Ptr<LteAnr> m_anr;

  Ptr<LteFfrAlgorithm> m_ffrAlgorithm; /**< DEPRECATE - It is maintained for backward compatibility */

  uint16_t m_cellId; /**< Cell Identifer. Part of the CGI, see TS 29.274, section 8.21.1  */

  uint8_t m_dlBandwidth; /**<DEPRECATE - It is maintained for backward compatibility - downlink bandwidth in RBs */
  uint8_t m_ulBandwidth; /**<DEPRECATE - It is maintained for backward compatibility - uplink bandwidth in RBs */

  uint16_t m_dlEarfcn;  /**<DEPRECATE - It is maintained for backward compatibility - downlink carrier frequency */
  uint16_t m_ulEarfcn;  /**<DEPRECATE - It is maintained for backward compatibility - uplink carrier frequency */
