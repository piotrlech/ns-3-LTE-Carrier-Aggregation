 ...
 *        to the Ue RRC instance.
 *
 * This is the *Component Carrier Management SAP Provider*, i.e., the part of the SAP
 * that contains the component carrier selection algorithm methods called by the Ue RRC
 * instance.
 */
...
template <class C>
void MemberLteUeCcmRrcSapProvider<C>::AmIalive ()
{
  m_owner->DoAmIalive ();
}
...
public:
  ...
  virtual void ComponentCarrierEnabling (std::vector<uint16_t> componentCarrierList) = 0;
  ...
  public:
    ...
    virtual void ComponentCarrierEnabling (std::vector<uint16_t> componentCarrierList);
...
template <class C>
void MemberLteUeCcmRrcSapUser<C>::ComponentCarrierEnabling (std::vector<uint16_t> componentCarrierList) 
{
