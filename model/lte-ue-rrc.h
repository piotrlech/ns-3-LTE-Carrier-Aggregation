...
public:
  ...
  void SetLteUeCphySapProvider (LteUeCphySapProvider * s, uint16_t index);
  ...
  LteUeCphySapUser* GetLteUeCphySapUser (uint16_t index);
  ...
  LteUeCmacSapUser* GetLteUeCmacSapUser (uint16_t index);
   ...
   */
  LteUeCcmRrcSapProvider* GetLteCcmRrcSapProvider ();
  void test();
...
private:
  ...
  void DoComponentCarrierEnabling (std::vector<uint16_t> res);
