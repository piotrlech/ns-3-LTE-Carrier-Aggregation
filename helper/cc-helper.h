...
public:
  ...
  Ptr<ComponentCarrierEnb> DoCreateSingleCc (uint16_t ulBandwidth, uint16_t dlBandwidth, uint16_t ulEarfcn, uint16_t dlEarfcn, bool isPrimary);
  ...
  */
  ...
  std::map< uint8_t, Ptr<ComponentCarrierEnb> > EquallySpacedCcs ();

  uint16_t  m_numberOfComponentCarries;
...
private:
   ...
   */
  Ptr<ComponentCarrierEnb> CreateSingleCc (uint16_t ulBandwidth, uint16_t dlBandwidth, uint16_t ulEarfcn, uint16_t dlEarfcn, bool isPrimary);
